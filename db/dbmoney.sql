...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2019 at 10:29 AM
...
--
ALTER TABLE `bills`
  MODIFY `BillsId` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `category`
  MODIFY `CategoryId` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
--
-- AUTO_INCREMENT for table `totals`
--
ALTER TABLE `totals`
  MODIFY `TotalsId` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
